 ...
 *
 * Este método carga el contenido del ficher DB_FILENAME en la variable
 * quizzes. El contenido de ese fichero esta en formato JSON.
 * La primera vez que se ejecute este método, el fichero DN_FILENAME no
 ...
 *  Si se produce algún error, se lanza una excepción que abortará
 *  la ejecución del programa.
 */
const save = () => {
 ...
 *
 * @param id Clave que identifica e quiz a borrar.
 */
